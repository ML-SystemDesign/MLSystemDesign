...
This directory contains educational mock examples of ML system design documents. These examples are created specifically for learning and demonstrate best practices using simplified scenarios.

## Current Examples

### EN (English)

1. **[RAG Chat with Document Versions](EN/RAG_Chat_With_Doc_Versions/RAG_Chat_With_Doc_Versions_Design.md)**
